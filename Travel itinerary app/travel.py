...
# Configure API key
api_key = "Google_API_key"  # Put API inside the quotes
...
def generate_itinerary(destination, days, nights):
    ...
    response = chat_session.send_message(f"Create a detailded travel itinerary for {days} days and {nights} nights in {destination}.")
...
def main():
    ...
    nights = st.number_input("Enter number of nights:", min_value=0)

    # Ensure that user inputs as provided
